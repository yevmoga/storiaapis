...
func (x *Article) GetCreated() *timestamppb.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
var file_blog_blog_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87, 0x01, 0x0a, 0x07, 0x41, 0x72, 0x74,
	...
	0x65, 0x64, 0x42, 0x06, 0x5a, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_blog_blog_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_blog_blog_proto_goTypes = []interface{}{
	(*Article)(nil),               // 0: blog.Article
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_blog_blog_proto_depIdxs = []int32{
	1, // 0: blog.Article.created:type_name -> google.protobuf.Timestamp
